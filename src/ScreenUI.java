...
public class ScreenUI implements ActionListener {
     ...
     * 
     * @param actionEvent Refente aos objetos da classe ActionEvent,adiciona um evento no botão pelo ActionListener.
     */
     ...
     * 
     * @param x1 Coodenada x1
     * @param y1 Coodenada y1
     * @param x2 Coodenada x2
     * @param y2 Coodenada y2
     ...
     * Esse metodo vai rodar o nosso algoritmo do Travel Salesman Problem(TSP).
     * 
     * @param actionEvent  Recebe como entrada a string do input_text e gera uma string para nossa saida, e entao a saida eh printada como uma mensagem na tela.
     */
    ...
    public void outputMessage(ActionEvent actionEvent) {
        ...
        // Aqui fazemos o parsing do input, precisamos saber como interpretar os argumentos, feito com uma conta rápida.
